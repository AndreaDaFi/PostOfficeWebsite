...
import { AppBar, Toolbar, Button, Container, Drawer, List, Box, IconButton, ListItem } from "@mui/material"
...
const App = () => {
  const { isCustomer, isAdmin, isManager, isDriver, isClerk, logout } = useContext(AuthContext)
          ...
          <>
            ...
            >
              ...
              <Box sx={{ flexGrow: 1 }}>
                <List sx={{ paddingTop: 2 }}>
                  ...
                  {/* Show Login, Signup & Track Package Only When NOT Logged In */}
                  {!user && (
                    <>
                      <ListItem>
                        <Button
                    ...
                    <>
                      <ListItem>
                        <DropMenuButton
                          ...
                          menuItems={[{ label: "PACKAGES REPORT", to: "/StoreSales" }]}
                        />
                      </ListItem>
                      <ListItem>
                        <DropMenuButton
            ...
            <Container style={{ marginTop: 20 }}>
              <Routes>
                ...
                {user && isCustomer() && <Route path="/dashboard" element={<Dashboard />} />}
