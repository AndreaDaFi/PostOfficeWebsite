...
export default function ViewStaffActivity() {
  ...
  return (
    <Container maxWidth={false} sx={{ my: 4, px: 0, width: "100%", maxWidth: "100%" }}>
              ...
              >
                <CardContent sx={{ p: 2 }}>
                  <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
                    <PersonIcon sx={{ color: "#D32F2F", mr: 1.5, fontSize: 24 }} />
            ...
            <Grid item xs={12} sm={6} md={3}>
              ...
              >
                <CardContent sx={{ p: 2 }}>
                  ...
                  <Typography variant="h3" fontWeight="bold" color="#D32F2F">
                    {totalHoursWorked > 0 ? (totalPackageUpdates / totalHoursWorked).toFixed(1) : "0.0"}
                  </Typography>
                    ...
                    <Table sx={{ width: "100%" }}>
                      <TableHead>
                        <TableRow sx={{ bgcolor: "#f5f5f5" }}>
                          <TableCell sx={{ fontWeight: "bold", padding: "12px 8px" }}>Employee</TableCell>
                          <TableCell sx={{ fontWeight: "bold", padding: "12px 8px" }}>Role</TableCell>
                          <TableCell sx={{ fontWeight: "bold", padding: "12px 8px" }}>Date</TableCell>
                          <TableCell sx={{ fontWeight: "bold", padding: "12px 8px" }}>Hours</TableCell>
                        </TableRow>
                      </TableHead>
                      <TableBody>
                          ...
                          >
                            ...
                            >
                              <Box sx={{ display: "flex", alignItems: "center" }}>
                                <PersonIcon sx={{ color: "#D32F2F", mr: 1, fontSize: 20 }} />
                                <Typography sx={{ fontWeight: "medium" }}>{employee.first_name || "N/A"}</Typography>
                              </Box>
                            </TableCell>
                            <TableCell
                              sx={{
                            ...
                            >
                              <Chip
                                ...
                                size="medium"
                                sx={{
                                  bgcolor: employee.role === "Driver" ? "#FFEBEE" : "#E8F5E9",
                                  color: employee.role === "Driver" ? "#D32F2F" : "#2E7D32",
                                  fontWeight: "medium",
                                  fontSize: "1rem",
                                }}
                              />
                            ...
                            >
                              <Typography fontWeight="medium">{employee.total_hours || 0}</Typography>
                            </TableCell>
                          </TableRow>
                        ))}
                      </TableBody>
                      <TableFooter>
                        <TableRow sx={{ bgcolor: "#f5f5f5", height: "60px" }}>
                          <TableCell colSpan={3} sx={{ textAlign: "right", fontWeight: "bold", fontSize: "1.2rem" }}>
                            Total Hours:
                          </TableCell>
                          <TableCell sx={{ fontWeight: "bold", color: "#D32F2F", fontSize: "1.2rem" }}>
                            {totalHoursWorked.toFixed(1)}
                          </TableCell>
                        </TableRow>
                      </TableFooter>
                    ...
                    <Table sx={{ width: "100%" }}>
                      <TableHead>
                        <TableRow sx={{ bgcolor: "#f5f5f5" }}>
                          <TableCell sx={{ fontWeight: "bold", padding: "12px 8px" }}>Employee</TableCell>
                          <TableCell sx={{ fontWeight: "bold", padding: "12px 8px" }}>Role</TableCell>
                          <TableCell sx={{ fontWeight: "bold", padding: "12px 8px" }}>Previous</TableCell>
                          <TableCell sx={{ fontWeight: "bold", padding: "12px 8px" }}>Updated</TableCell>
                          <TableCell sx={{ fontWeight: "bold", padding: "12px 8px" }}>Type</TableCell>
                        </TableRow>
                      </TableHead>
                      <TableBody>
                        {filteredData.map((item, index) => (
                          ...
                          >
                            ...
                            >
                              <Box sx={{ display: "flex", alignItems: "center" }}>
                                <PersonIcon sx={{ color: "#D32F2F", mr: 1, fontSize: 20 }} />
                                <Typography sx={{ fontWeight: "medium" }}>{item.first_name || "N/A"}</Typography>
                              </Box>
                            </TableCell>
                            <TableCell
                              sx={{
                            ...
                            >
                              <Chip
                                ...
                                size="medium"
                                sx={{
                                  bgcolor: item.role === "Driver" ? "#FFEBEE" : "#E8F5E9",
                                  color: item.role === "Driver" ? "#D32F2F" : "#2E7D32",
                                  fontWeight: "medium",
                                  fontSize: "1rem",
                                }}
                              />
