...
export default function CustLogin() {
  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await fetch("https://final-po-api.vercel.app/api/custLogin", {
        method: "POST",
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const response = await fetch(`https://final-po-api.vercel.app/api/CustEmailExists?email=${email}`, {
        method: "GET",
      })
  ...
  const handleNewPass = async () => {
    ...
    try {
      const response = await fetch("https://final-po-api.vercel.app/api/CustNewPass", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
