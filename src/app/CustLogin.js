...
export default function CustLogin() {
  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await fetch("https://vercel-api-powebapp.vercel.app/custLogin", {
        method: "POST",
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const response = await fetch("https://vercel-api-powebapp.vercel.app/resetPassword", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
