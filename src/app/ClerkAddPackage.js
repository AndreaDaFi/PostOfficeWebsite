  ...
  return (
    <Container maxWidth="md" style={{ marginTop: "20px", marginBottom: "20px" }}>
      <Paper elevation={3} style={{ padding: "20px", borderRadius: "12px", textAlign: "center" }}>
        ...
        {/* Receiver Info */}
        <Typography variant="h6" style={{ fontWeight: "bold", marginTop: "10px" }}> Customer Information</Typography>
        <Grid container spacing={2}>
          <Grid item xs={6}><TextField fullWidth label="Customer ID" name="receiverFirstName" variant="outlined" value={packageData.receiverFirstName} onChange={(e) => setPackageData({ ...packageData, receiverFirstName: e.target.value })} /></Grid>
